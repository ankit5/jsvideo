...
<body style="height: 100%; margin: 0; overflow: hidden;">
  ...
  <div id="play">
    <iframe src="https://hdmovies2.online/player.php" style="overflow:hidden;overflow-x:hidden;overflow-y:hidden;height:100%;width:100%;position:absolute;top:0%;left:0px;right:0px;bottom:0px" height="100%" width="100%" frameborder="0"></iframe>
